...
public class FileListener extends FileAlterationListenerAdaptor {
	...
	public void onFileCreate(File file) {
		logger.warn("[新建]:{}", file.getAbsolutePath());
//		callBack.emit(file);
	}
	...
	public void onFileChange(File file) {
		logger.warn("[修改]:{}", file.getAbsolutePath());
		callBack.emit(file);
	}
	...
	public void onFileDelete(File file) {
		logger.warn("[删除]:{}", file.getAbsolutePath());
//		callBack.emit(file);
	}
	...
	public void onDirectoryCreate(File directory) {
		logger.warn("[新建]:{}", directory.getAbsolutePath());
//		callBack.emit(directory);
	...
	public void onDirectoryChange(File directory) {
		logger.warn("[修改]:{}", directory.getAbsolutePath());
//		callBack.emit(directory);
	}
	...
	public void onDirectoryDelete(File directory) {
		logger.warn("[删除]:{}", directory.getAbsolutePath());
//		callBack.emit(directory);
	}
